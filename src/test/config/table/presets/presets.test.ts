...
import arPresets from '../../../../config/table/presets/ar'
import dePresets from '../../../../config/table/presets/de'
import enPresets from '../../../../config/table/presets/en'
import esPresets from '../../../../config/table/presets/es'
import frPresets from '../../../../config/table/presets/fr'
import jaPresets from '../../../../config/table/presets/ja'
import noPresets from '../../../../config/table/presets/no'
import ptPresets from '../../../../config/table/presets/pt'
