...
vi.mock('react-i18next', () => {
  const translations: Record<string, string> = {
    ...
    'meta.testimonialsDescription': 'Hear from writers, analysts, researchers, and technical thinkers who use Tablesmit every day — the free online table builder with drag-to-resize, merge cells, and export.',
    ...
    'meta.changelogDescription': 'Every release of Tablesmit, documented. See what is new, fixed, and improved in each version of the free online table builder for writers and researchers.',
    ...
    'meta.termsDescription': 'Tablesmit Terms of Use — your rights, our responsibilities. Covers open source licensing, data privacy, acceptable use, and liability limitations for the free online table builder.',
    // grid
