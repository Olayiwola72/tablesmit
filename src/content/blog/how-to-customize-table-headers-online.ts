...
const post: BlogPost = {
  slug: 'how-to-customize-table-headers-online',
...
1. Create a table. By default, the first row is styled as a header.
2. Open the **Header Options** panel in the left sidebar.
3. Change the header style from "First row" to "Both" or "None".
