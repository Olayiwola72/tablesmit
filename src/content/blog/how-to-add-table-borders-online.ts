...
const post: BlogPost = {
  slug: 'how-to-add-table-borders-online',
...
1. Select the cells you want to modify. Click and drag, or Shift+click a range.
2. Open the Border panel in the right sidebar.
3. Click the border preset you want. The table updates immediately.
4. Use the color picker to change the border color if needed.
