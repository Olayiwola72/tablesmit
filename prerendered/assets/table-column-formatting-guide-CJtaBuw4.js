var e={slug:"table-column-formatting-guide",title:"How to Format Table Columns by Type — Number, Currency, Date, and More",date:"2026-05-22",description:"Not every column should behave like plain text. Here is a practical guide to column formats and when each one makes your table clearer.",author:"Olayiwola Akinnagbe",tags:["column formatting","column types","guide"],readTime:5,featured:!1,content:`## Why column types matter
...
Open [Tablesmit](/) and select any column in your table, then open the Column Formatting panel to try the available types.`,relatedFeature:"column-types"};export{e as default};
