var e={slug:"how-to-find-and-replace-in-table",title:"How to Find and Replace Text in a Table Online",date:"2026-04-18",description:"The browser's built-in find bar does not navigate between table cells. Here is a table-aware find and replace that works inside your data.",author:"Olayiwola Akinnagbe",tags:["find and replace","search table","tutorial"],readTime:3,featured:!1,content:`## Why the browser find bar is not enough
...
Open [Tablesmit](/), press Ctrl+F, and search your table data.`,relatedFeature:"find-replace"};export{e as default};
