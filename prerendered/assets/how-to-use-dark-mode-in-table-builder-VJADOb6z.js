var e={slug:"how-to-use-dark-mode-in-table-builder",title:"How to Use Dark Mode in a Table Builder for Low-Light Work",date:"2026-04-30",description:"Dark mode reduces eye strain in low-light environments. Here is how to enable it in a table builder and what changes when you switch.",author:"Olayiwola Akinnagbe",tags:["dark mode","table editor","accessibility"],readTime:3,featured:!1,content:`## Why dark mode matters for table work
...
Open [Tablesmit](/) and click the moon icon in the top navigation bar. The interface switches to dark mode. Click again to switch back.`,relatedFeature:"dark-mode"};export{e as default};
