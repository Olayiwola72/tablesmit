var e={slug:"how-to-use-right-click-table-editor",title:"How to Use Right-Click in an Online Table Editor",date:"2026-05-31",description:"Right-click any cell or column header to access AutoFit, insert and delete rows or columns, sort, copy, and paste — without reaching for the toolbar.",author:"Olayiwola Akinnagbe",tags:["context menu","right-click","productivity","tutorial","tables"],readTime:4,featured:!1,content:`## The fastest way to edit tables
...
Both are always available. Use whichever fits the moment.`,relatedFeature:"context-menu"};export{e as default};
