var e={slug:"offline-table-builder",title:"How to Use a Table Builder Without an Internet Connection",date:"2026-05-21",description:"Most web tools stop when your connection drops. {{BRAND_NAME}} works offline — build, edit, and export tables on a plane, in a tunnel, or anywhere Wi-Fi fails.",author:"Olayiwola Akinnagbe",tags:["offline","pwa","productivity"],readTime:4,featured:!1,content:`## The problem with browser-based tools and travel
...
[Open Tablesmit](/) — then take it anywhere you go.`,relatedFeature:"offline"};export{e as default};
