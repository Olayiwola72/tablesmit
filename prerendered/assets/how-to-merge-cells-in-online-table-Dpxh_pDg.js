var e={slug:"how-to-merge-cells-in-online-table",title:"How to Merge Cells in an Online Table",date:"2026-05-15",description:"Most web table tools do not support cell merging. Here is how to merge and unmerge cells in {{BRAND_NAME}} — and when to use it in your tables.",author:"Olayiwola Akinnagbe",tags:["merge cells","tutorial","tables"],readTime:4,featured:!1,content:`## What is cell merging?
...
[Build your table in Tablesmit](/) — merge cells included.`,relatedFeature:"merge-cells"};export{e as default};
