var e={slug:"how-to-auto-sum-columns-table",title:"How to Auto-Sum Columns in an Online Table",date:"2026-05-25",description:"Need a total row at the bottom of your table? Enable Auto-Sum on any Number, Currency, or Percentage column. {{BRAND_NAME}} calculates it for you.",author:"Olayiwola Akinnagbe",tags:["auto-sum","numbers","productivity","tutorial","tables"],readTime:4,featured:!1,content:`## A table that adds itself
...
Select a numeric column. Open Column Type. Choose Currency. Toggle Show sum row. Your table now has a running total — updated automatically as you edit.`,relatedFeature:"auto-sum"};export{e as default};
