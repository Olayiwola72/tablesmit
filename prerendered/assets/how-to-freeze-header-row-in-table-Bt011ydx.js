var e={slug:"how-to-freeze-header-row-in-table",title:"How to Freeze a Header Row in a Table So It Stays Visible While Scrolling",date:"2026-05-11",description:"When a table is tall enough to scroll, the header disappears. Freezing the header row keeps column labels visible while you scroll through your data.",author:"Olayiwola Akinnagbe",tags:["freeze header","sticky row","tutorial"],readTime:3,featured:!1,content:`## The problem with scrolling tables
...
Open [Tablesmit](/), create a table with at least fifteen rows, and toggle the freeze header option. Scroll and see the headers stay in place.`,relatedFeature:"freeze-panes"};export{e as default};
