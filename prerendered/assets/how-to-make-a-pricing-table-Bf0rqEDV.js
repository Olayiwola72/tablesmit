var e={slug:"how-to-make-a-pricing-table",title:"How to Make a Pricing Table Online",date:"2026-05-23",description:"A pricing table that looks unprofessional costs you clients before you have even spoken. Here is how to build one that earns trust — in under five minutes.",author:"Olayiwola Akinnagbe",tags:["pricing table","tutorial","templates"],readTime:5,featured:!1,content:`## Why the pricing table matters more than you think
...
Your pricing table is the last thing a client reads before deciding whether to reply to your proposal. [Build it properly in Tablesmit](/) — it takes less time than you think and the difference is visible.`};export{e as default};
