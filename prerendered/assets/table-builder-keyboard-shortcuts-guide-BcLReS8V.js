var e={slug:"table-builder-keyboard-shortcuts-guide",title:"10 Table Builder Keyboard Shortcuts Every Power User Should Know",date:"2026-05-22",description:"Speed up your table editing with keyboard shortcuts. Navigate cells, merge, undo, copy, find and replace — all without touching the mouse.",author:"Olayiwola Akinnagbe",tags:["shortcuts","productivity","keyboard","tutorial","tables"],readTime:5,featured:!0,content:`## Why keyboard shortcuts matter
...
Every shortcut you learn is one less trip to the toolbar.`,relatedFeature:"keyboard-shortcuts"};export{e as default};
