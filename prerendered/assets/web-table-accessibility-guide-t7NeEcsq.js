var e={slug:"web-table-accessibility-guide",title:"Web Table Accessibility — How to Make Tables Usable With a Screen Reader",date:"2026-03-27",description:"Tables are one of the hardest HTML elements to navigate with a screen reader. Here is how to build tables that work for everyone.",author:"Olayiwola Akinnagbe",tags:["accessibility","screen reader","a11y"],readTime:4,featured:!1,content:`## Why table accessibility matters
...
Build an accessible table in [Tablesmit](/) — the grid pattern and keyboard navigation are active from the first cell.`,relatedFeature:"accessible-tables"};export{e as default};
